...
public class GUIMachineRadGen extends GuiInfoContainer {
	...
	private static ResourceLocation texture = new ResourceLocation(Tags.MODID + ":textures/gui/gui_radgen.png");
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		String name = this.radgen.hasCustomName() ? this.radgen.getName() : I18n.format(this.radgen.getName());
