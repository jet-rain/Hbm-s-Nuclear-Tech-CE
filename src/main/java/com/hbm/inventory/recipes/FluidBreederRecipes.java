...
public class FluidBreederRecipes extends SerializableRecipe {
    ...
    public static Map<FluidType, Tuple.Pair<Integer, FluidStack>> recipes = new HashMap<>();
    ...
    public void readRecipe(JsonElement recipe) {
        ...
        this.recipes.put(input.type, new Tuple.Pair(input.fill, output));
    }

    @Override
    public void writeRecipe(Object recipe, JsonWriter writer) throws IOException {
        Map.Entry<FluidType, Tuple.Pair<Integer, FluidStack>> rec = (Map.Entry<FluidType, Tuple.Pair<Integer, FluidStack>>) recipe;
