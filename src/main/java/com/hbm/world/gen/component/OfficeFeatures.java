...
public class OfficeFeatures {
    ...
    public static void registerComponents() {
        MapGenStructureIO.registerStructureComponent(LargeOffice.class, "NTMLargeOffice");
        MapGenStructureIO.registerStructureComponent(LargeOfficeCorner.class, "NTMLargeOfficeCorner");
    }
    ...
    public static class LargeOffice extends Component {
        ...
        @Override
        protected void writeStructureToNBT(@NotNull NBTTagCompound tagCompound) {
        }

        @Override
        protected void readStructureFromNBT(@NotNull NBTTagCompound tagCompound, @NotNull TemplateManager p_143011_2_) {
        }
        ...
        @Override
        public boolean addComponentParts(@NotNull World world, @NotNull Random rand, @NotNull StructureBoundingBox box) {
            ...
            //Desk 1 :3
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaEU), 1, 1, 4, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaNU), 2, 1, 4, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaWU), 3, 1, 4, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairMetaS), 2, 1, 3, box); //Chaiw :3
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(0)), 1, 2, 4, box); //Nowth-facing Computer :33
            //Desk 2 :3
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairMetaS), 7, 1, 3, box); //Chaiw :3
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaEU), 6, 1, 4, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaWU), 7, 1, 4, box);
            setBlockState(world, Blocks.PLANKS.getStateFromMeta(1), 8, 1, 4, box); //Spwuce Pwanks :3
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(0)), 7, 2, 4, box); //Nowth-facing Computer X3
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 8, 2, 4, box);
            //Desk 3 :3
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaEU), 10, 1, 1, box);
            fillWithMetadataBlocks(world, box, 11, 1, 1, 14 - 1, 1, 1, Blocks.SPRUCE_STAIRS, stairMetaSU);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaNU), 14 - 1, 1, 2, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaSU), 14 - 1, 1, 3, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaWU), 14 - 1, 1, 4, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaNU), 14 - 1, 1, 5, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairMetaN), 11, 1, 2, box); //Chaiw ;3
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairMetaE), 14 - 2, 1, 4, box); //Chaiw :333
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(1)), 14 - 3, 2, 1, box); //South-facing Computer :3
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(2)), 14 - 1, 2, 5, box); //West-facing Computer ^w^
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 14 - 1, 2, 3, box);
            setBlockState(world, ModBlocks.radiorec.getStateFromMeta(getDecoMeta(5)), 14 - 1, 2, 2, box); //Wadio
            //Desk 4 DX
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaEU), 10, 1, 8, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaWU), 11, 1, 8, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairMetaN), 10, 1, 9, box); //Chaiw ;3
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(1)), 10, 2, 8, box); //South-facing Computer :33
            //Desk 5 :333
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaSU), 14 - 1, 1, 12 - 3, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaWU), 14 - 1, 1, 12 - 2, box);
            setBlockState(world, Blocks.SPRUCE_STAIRS.getStateFromMeta(stairMetaNU), 14 - 1, 1, 12 - 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(stairMetaE), 14 - 3, 1, 12 - 1, box); //UwU... Chaiw!!!! :333 I wove chaiws XD :333 OwO what's this?? chaiw???? :333333333333333333
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(2)), 14 - 1, 2, 12 - 1, box); //West-facing Computer >w<
            //Cobwebs pwobabwy
    ...
    public static class LargeOfficeCorner extends Component {
        ...
        public boolean addComponentParts(@NotNull World world, @NotNull Random rand, @NotNull StructureBoundingBox box) {
            ...
            setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(pillarMetaWE), 6, 0, 3, box);
            ...
            setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 3, 0, 14, box);
            ...
            setBlockState(world, ModBlocks.concrete_pillar.getStateFromMeta(0), 0, 0, 11, box);
            ...
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 9, 1, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 8, 1, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 8, 2, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 7, 2, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 7, 3, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 6, 3, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 6, 4, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 6, 4, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMeta), 6, 5, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 7, 5, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMeta), 7, 6, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 8, 6, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMeta), 8, 7, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 9, 7, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMeta), 9, 8, 2, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 9, 8, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 9, 9, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 8, 9, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 8, 10, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 7, 10, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 7, 11, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 6, 11, 1, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 6, 12, 1, box);
            ...
            //Doors
            placeDoor(world, box, Blocks.OAK_DOOR, 3, false, rand.nextBoolean(), 1, 1, 14);
            placeDoor(world, box, Blocks.OAK_DOOR, 3, true, rand.nextBoolean(), 2, 1, 14);
            placeDoor(world, box, Blocks.OAK_DOOR, 0, false, rand.nextBoolean(), 0, 1, 12);
            placeDoor(world, box, Blocks.OAK_DOOR, 0, true, rand.nextBoolean(), 0, 1, 13);
            ...
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 2, 1, 5, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(SouthStairMeta), 2, 1, 7, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 2, 1, 8, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(NorthStairMeta), 2, 1, 9, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 8, 1, 4, box);
            fillWithMetadataBlocks(world, box, 8, 1, 5, 8, 1, 7, Blocks.WOODEN_SLAB, 13);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(NorthStairMetaUD), 8, 1, 8, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 9, 1, 8, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMeta), 9, 1, 5, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 9, 1, 4, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(10), 8, 2, 7, box);

            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 6, 1, 12, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(NorthStairMeta), 7, 1, 12, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMeta), 8, 1, 12, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 10, 1, 11, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(NorthStairMetaUD), 10, 1, 12, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 10, 2, 11, box);
            //Floor 2
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 4, 5, 4, box);
            setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(13), 3, 5, 4, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 2, 5, 4, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(NorthStairMeta), 3, 5, 5, box);
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(1)), 3, 6, 4, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 3, 5, 7, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 4, 5, 7, box);
            setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(13), 4, 5, 8, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(NorthStairMetaUD), 4, 5, 9, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 2, 5, 9, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 10, 5, 4, box);
            setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(13), 10, 5, 5, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(NorthStairMetaUD), 10, 5, 6, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(NorthStairMeta), 8, 5, 6, box);
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(2)), 10, 6, 6, box);

            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(NorthStairMetaUD), 8, 5, 11, box);
            setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(13), 8, 5, 10, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 8, 5, 9, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 9, 5, 9, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 10, 5, 9, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(WestStairMeta), 10, 5, 10, box);
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(1)), 9, 6, 9, box);

            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(NorthStairMetaUD), 1, 5, 13, box);
            setBlockState(world, Blocks.WOODEN_SLAB.getStateFromMeta(13), 1, 5, 12, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 1, 5, 11, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(NorthStairMeta), 3, 5, 13, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 1, 6, 12, box);
            setBlockState(world, ModBlocks.machine_microwave.getStateFromMeta(getDecoMeta(5)), 1, 6, 11, box);
            //Floor 3
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 8, 9, 4, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 7, 9, 4, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 9, 9, 4, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 5, 9, 5, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 5, 9, 6, box);
            fillWithMetadataBlocks(world, box, 3, 9, 6, 4, 9, 6, Blocks.WOODEN_SLAB, 13);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 2, 9, 6, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(SouthStairMeta), 3, 9, 5, box);
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(0)), 3, 10, 6, box);

            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 9, 9, 10, box);
            fillWithMetadataBlocks(world, box, 7, 9, 10, 8, 9, 10, Blocks.WOODEN_SLAB, 13);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(SouthStairMetaUD), 6, 9, 10, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 5, 9, 10, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 5, 9, 11, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(NorthStairMetaUD), 5, 9, 12, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(NorthStairMeta), 8, 9, 11, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(EastStairMeta), 7, 9, 8, box);
            setBlockState(world, Blocks.OAK_STAIRS.getStateFromMeta(SouthStairMeta), 9, 9, 8, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 6, 10, 10, box);
            setBlockState(world, ModBlocks.deco_computer.getStateFromMeta(getDecoModelMeta(1)), 7, 10, 10, box);
            setBlockState(world, ModBlocks.tape_recorder.getStateFromMeta(getDecoMeta(5)), 6, 9, 11, box);
            placeRandomBobble(world, box, rand, 5, 10, 11);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(WestStairMetaUD), 2, 9, 11, box);
            setBlockState(world, Blocks.DARK_OAK_STAIRS.getStateFromMeta(EastStairMetaUD), 1, 9, 11, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 2, 10, 11, box);

            //Roof
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 5, 13, 9, box);
            setBlockState(world, Blocks.FLOWER_POT.getStateFromMeta(0), 7, 13, 11, box);
            ...
            setBlockState(world, ModBlocks.deco_loot.getStateFromMeta(0), 6, 13, 11, box);
            LootGenerator.lootCapStash(world, this.getXWithOffset(6, 11), this.getYWithOffset(13), this.getZWithOffset(6, 11));
            setBlockState(world, ModBlocks.deco_loot.getStateFromMeta(0), 1, 10, 11, box);
